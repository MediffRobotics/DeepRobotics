...
int MyMap(int inputVal){
  ...
  return map(inputVal, 200, 600, 20, 119);  
}
bool SendData_BaseMotorByPressSensor(){
  static float Qk1=600;
  static float Qk=0;
  
  static float Pk1=600;
  static float Pk=0;
  ...
  outputValue_BaseSensor_DIR0 = MyMap(sensorValue_Base_DIR0);  
  outputValue_BaseSensor_DIR1 = MyMap(sensorValue_Base_DIR1);
   //Serial.println(Qk);
