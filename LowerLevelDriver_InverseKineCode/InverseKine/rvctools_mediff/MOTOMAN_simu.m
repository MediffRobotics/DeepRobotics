...
L(2) = Revolute('d', 0, 'a', 0, 'alpha', -90);

L(3) = Revolute('d', 0, 'a', 1, 'alpha', 0);

% L(4) = Revolute('d', 1, 'a', 0, 'alpha', pi/2,  ...
...
%     'qlim', [-100 100]*deg );
% 
% L(6) = Revolute('d', 0.3, 'a', 0, 'alpha', 0,  ...
...
p560 = SerialLink(L, 'name', 'MOTO MAN', ...
...
%p560.plot([0 -pi/4 -pi/4 0 pi/8 0] );
p560.plot([0 0 pi/2] );
