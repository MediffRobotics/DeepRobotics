...
void UpperArmGivenSteps( unsigned long steps,bool Step_direction){  
 ...
 void PressureSensorControl_UpperArmStepper_ISR(){
...
void Acceleration_UpperArmStepper_ISR(){
  ...
  //UpperArmStepper_ISR();    
  PressureSensorControl_UpperArmStepper_ISR();
}
...
//if finished working,send serial a flag to rpi
...
void ControlSteppersBySerial(){  
      ...
      /////////////////////// Move motor by steps and period
      numPeriod=abs(numPeriod);
      MoveMotorByPeriod(numPeriod); 
...
void MoveMotorByPeriod(unsigned int periodVal){
