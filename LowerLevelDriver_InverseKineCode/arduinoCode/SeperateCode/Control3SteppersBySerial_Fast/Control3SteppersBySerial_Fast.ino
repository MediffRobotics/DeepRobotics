...
void Axis_RotateGivenSteps(unsigned long steps,bool Step_direction){
...
void ElbowRotateGivenSteps(unsigned long TargetSteps,bool Step_direction){        
...
{      
 ...
 // Serial.println(uparmStepper_WorkingFlag);
  /*
  if(uparmStepper_WorkingFlag==true){
    Serial.println(StepCounter_UPARM);
  }*/
...
void StepperWorkingCheck(){
  //upper arm 
   ...
   if(sentFlag_Uparm==true){
     sentFlag_Uparm=false;
     Serial.println('f');  // tell pc end, the task is done
   }
   
   if(sentFlag_Elbow==true){
     sentFlag_Elbow=false;
     Serial.println('g');  // tell pc end, the task is done
   }
   
      if(sentFlag_Axis==true){
     sentFlag_Axis=false;
     Serial.println('h');  // tell pc end, the task is done
   }
